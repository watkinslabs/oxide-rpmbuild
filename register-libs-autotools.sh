...
reg libunistring 1.2      "LGPL-3.0-or-later" "libunistring -devel (oxide)" "--enable-shared --disable-static --disable-rpath" https://mirrors.kernel.org/gnu/libunistring/libunistring-1.2.tar.gz libunistring-1.2.tar.gz
...
$V src add --package ncurses --version 6.5 --url https://mirrors.kernel.org/gnu/ncurses/ncurses-6.5.tar.gz --filename ncurses-6.5.tar.gz 2>/dev/null || true
