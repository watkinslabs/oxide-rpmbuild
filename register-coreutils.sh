...
$V src add --package coreutils --version 8.32 --url https://mirrors.kernel.org/gnu/coreutils/coreutils-8.32.tar.xz --filename coreutils-8.32.tar.xz 2>/dev/null || true
