...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/zoxide %{buildroot}/usr/bin/zoxide
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/zoxide.files

%files -f %{_builddir}/zoxide.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 0.9.6-1
