...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/dust %{buildroot}/usr/bin/dust
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/dust.files

%files -f %{_builddir}/dust.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 1.1.1-1
