...
Version:        1.4.19
Release:        1%{?dist}
Summary:        GNU m4 macro processor (oxide)
License:        GPL-3.0-or-later
Source0:        m4-1.4.19.tar.gz

%description
GNU m4 macro processor (oxide)
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/m4.files

%files -f %{_builddir}/m4.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 1.4.19-1
