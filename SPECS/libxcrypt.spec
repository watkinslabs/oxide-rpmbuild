...
./configure --build=x86_64-pc-linux-gnu --host=%{_target_cpu}-linux-musl --prefix=/usr --enable-shared --disable-static --disable-werror --enable-hashes=glibc --enable-obsolete-api=glibc
make %{?_smp_mflags}
