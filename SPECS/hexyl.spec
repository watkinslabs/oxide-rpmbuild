...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/hexyl %{buildroot}/usr/bin/hexyl
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/hexyl.files

%files -f %{_builddir}/hexyl.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 0.15.0-1
