...
Version:        0.23.0
Release:        1%{?dist}
Summary:        xh: HTTP client (oxide)
License:        MIT
Source0:        xh-0.23.0.tar.gz

%description
xh: HTTP client (oxide)
...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/xh %{buildroot}/usr/bin/xh
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/xh.files

%files -f %{_builddir}/xh.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 0.23.0-1
