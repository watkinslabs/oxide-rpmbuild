...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --with-openssl=$SYS/usr --with-zlib=$SYS/usr --without-libpsl --without-brotli --without-zstd --without-nghttp2 --without-nghttp3 --without-ngtcp2 --without-libssh2 --without-libidn2 --without-librtmp --disable-ldap --disable-ldaps --disable-docs --prefix=/usr
make %{?_smp_mflags}
