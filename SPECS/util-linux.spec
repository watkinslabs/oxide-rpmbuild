...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --cache-file=config.cache --prefix=/usr --bindir=/bin --sbindir=/sbin --disable-nls --disable-rpath --disable-makeinstall-chown --without-python --disable-liblastlog2 --without-systemd --without-systemdsystemunitdir --without-tmpfilesdir --without-cap-ng --without-selinux --without-audit --without-econf --without-cryptsetup --without-btrfs --without-libutempter --without-readline
make %{?_smp_mflags}
