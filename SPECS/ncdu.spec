...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --with-ncursesw
make %{?_smp_mflags}
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/ncdu.files

%files -f %{_builddir}/ncdu.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 1.21-1
