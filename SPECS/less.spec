...
Version:        643
Release:        1%{?dist}
Summary:        less pager (oxide)
License:        GPL-3.0-or-later
Source0:        less-643.tar.gz
...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --with-regex=posix
make %{?_smp_mflags}
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/less.files

%files -f %{_builddir}/less.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 643-1
