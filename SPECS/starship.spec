...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/starship %{buildroot}/usr/bin/starship
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/starship.files

%files -f %{_builddir}/starship.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 1.21.1-1
