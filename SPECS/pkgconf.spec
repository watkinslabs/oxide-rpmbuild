...
Version:        2.3.0
Release:        1%{?dist}
Summary:        pkgconf (pkg-config) (oxide)
License:        ISC
Source0:        pkgconf-2.3.0.tar.gz

%description
pkgconf (pkg-config) (oxide)

%prep
%setup -q -n pkgconf-2.3.0
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/pkgconf.files

%files -f %{_builddir}/pkgconf.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 2.3.0-1
