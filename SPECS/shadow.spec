...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --bindir=/bin --sbindir=/sbin --disable-nls --disable-rpath --without-selinux --without-audit --without-libcrack --without-libbsd --without-libpasswdqc --without-tcb --without-su --with-libpam --disable-logind --disable-account-tools-setuid --enable-shadowgrp
make %{?_smp_mflags}
