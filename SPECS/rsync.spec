...
./configure --build=x86_64-pc-linux-gnu --host=%{_target_cpu}-linux-musl --cache-file=config.cache --prefix=/usr --disable-md2man --disable-xxhash --disable-zstd --disable-lz4 --disable-openssl --disable-roll-simd --disable-roll-asm --with-included-popt --with-included-zlib
make %{?_smp_mflags}
