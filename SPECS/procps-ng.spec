...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --cache-file=config.cache --prefix=/usr --bindir=/bin --sbindir=/sbin --disable-nls --disable-rpath --without-systemd --without-elogind --disable-modern-top
make %{?_smp_mflags}
