...
Version:        2.3.2
Release:        1%{?dist}
Summary:        acl -devel (oxide)
License:        LGPL-2.1-or-later
Source0:        acl-2.3.2.tar.gz
...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --enable-shared --disable-static --disable-nls --disable-rpath
make %{?_smp_mflags}
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/acl.files

%files -f %{_builddir}/acl.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 2.3.2-1
