...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --enable-unicode --disable-unwind --disable-hwloc --disable-sensors --disable-capabilities --disable-delayacct
make %{?_smp_mflags}
