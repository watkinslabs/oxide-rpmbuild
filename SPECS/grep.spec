...
./configure --build=x86_64-pc-linux-gnu --host=%{_target_cpu}-linux-musl --disable-nls --disable-perl-regexp --without-libsigsegv-prefix --with-included-regex --prefix=/usr
make %{?_smp_mflags}
