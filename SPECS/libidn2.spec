...
LDFLAGS="-Wl,-rpath-link,$SYS/usr/lib -L$SYS/usr/lib -lunistring" \
PKG_CONFIG_LIBDIR="$SYS/usr/lib/pkgconfig" PKG_CONFIG_SYSROOT_DIR="$SYS" PKG_CONFIG_PATH="" \
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --enable-shared --disable-static --disable-doc --disable-nls --disable-rpath --with-libunistring-prefix=$SYS/usr
make %{?_smp_mflags}
