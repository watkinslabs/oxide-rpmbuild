...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/grex %{buildroot}/usr/bin/grex
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/grex.files

%files -f %{_builddir}/grex.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 1.4.5-1
