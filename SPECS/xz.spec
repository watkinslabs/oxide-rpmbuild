...
./configure --build=x86_64-pc-linux-gnu --host=%{_target_cpu}-linux-musl --disable-nls --disable-shared --enable-static --disable-doc --disable-scripts --disable-lzma-links --prefix=/usr
make %{?_smp_mflags}
