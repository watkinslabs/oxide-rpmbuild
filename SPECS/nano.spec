...
Version:        8.2
Release:        1%{?dist}
Summary:        nano editor (oxide)
License:        GPL-3.0-or-later
Source0:        nano-8.2.tar.xz
...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --disable-nls --disable-libmagic --disable-speller
make %{?_smp_mflags}
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/nano.files

%files -f %{_builddir}/nano.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 8.2-1
