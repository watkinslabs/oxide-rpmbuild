...
./configure --build=x86_64-pc-linux-gnu --host=%{_target_cpu}-linux-musl --prefix=/usr --enable-shared --disable-static --without-docbook --without-examples --without-tests
make %{?_smp_mflags}
