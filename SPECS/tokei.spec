...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/tokei %{buildroot}/usr/bin/tokei
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/tokei.files

%files -f %{_builddir}/tokei.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 12.1.2-1
