...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --cache-file=config.cache --with-ssl=openssl --with-openssl=yes --with-zlib --without-libpsl --enable-iri --disable-nls --prefix=/usr
make %{?_smp_mflags}
