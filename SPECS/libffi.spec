...
Version:        3.4.6
Release:        1%{?dist}
Summary:        libffi -devel (oxide)
License:        MIT
Source0:        libffi-3.4.6.tar.gz
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/libffi.files

%files -f %{_builddir}/libffi.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 3.4.6-1
