...
install -m0755 target/%{_target_cpu}-unknown-linux-musl/release/dua %{buildroot}/usr/bin/dua
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/dua.files

%files -f %{_builddir}/dua.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 2.30.1-1
