...
Version:        3.8.2
Release:        1%{?dist}
Summary:        GNU bison parser generator (oxide)
License:        GPL-3.0-or-later
Source0:        bison-3.8.2.tar.gz

%description
GNU bison parser generator (oxide)
...
./configure --build=x86_64-pc-linux-gnu --host=$TRIPLE --prefix=/usr --disable-nls
make %{?_smp_mflags}
...
( cd %{buildroot} && find . -type f -o -type l ) | sed 's#^\.##' | LC_ALL=C sort > %{_builddir}/bison.files

%files -f %{_builddir}/bison.files
%changelog
* Sat Jun 13 2026 Chris Watkins <chris@watkinslabs.com> - 3.8.2-1
